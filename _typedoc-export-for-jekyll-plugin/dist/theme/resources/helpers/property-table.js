(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./comment", "./escape", "./signature-title", "./strip-line-breaks", "./type"], factory);
    }
    ...
    function propertyTable() {
        ...
        const flattenParams = (current) => {
            ...
            return (_c = (_b = (_a = current.type) === null || _a === void 0 ? void 0 : _a.declaration) === null || _b === void 0 ? void 0 : _b.children) === null || _c === void 0 ? void 0 : _c.reduce((acc, child) => {
                const childObj = Object.assign(Object.assign({}, child), { name: `${current.name}.${child.name}` });
