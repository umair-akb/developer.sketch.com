...
CMD_TYPEDOC_PACKAGE_TYPES="$TYPEDOC_BIN -excludeExternals --exclude \"**/**/*test*/*\" --out $ABS_LOCAL_ASSISTANTS_OUT/types $ABS_ASSISTANTS_PKG_TYPES"
CMD_TYPEDOC_PACKAGE_UTILS="$TYPEDOC_BIN -excludeExternals --exclude \"**/**/*test*/*\" --out $ABS_LOCAL_ASSISTANTS_OUT/utils $ABS_ASSISTANTS_PKG_UTILS"
